...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('date-fns/add_seconds'), require('rxjs/Observable'), require('rxjs/observable/of'), require('rxjs/operators'), require('rxjs/BehaviorSubject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common/http', 'date-fns/add_seconds', 'rxjs/Observable', 'rxjs/observable/of', 'rxjs/operators', 'rxjs/BehaviorSubject'], factory) :
	(factory((global.delon = global.delon || {}, global.delon.cache = {}),global.ng.core,global.ng.common.http,global['date-fns/add_seconds/index'],global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx));
}(this, (function (exports,core,http,addSeconds,Observable,of,operators,BehaviorSubject) { 'use strict';
...
var CacheService = /** @class */ (function () {
    ...
    function (obj, path, defaultValue) {
        if (!obj)
            return defaultValue;
        if (path.length <= 1) {
            var /** @type {?} */ checkObj = path.length ? obj[path[0]] : obj;
    ...
    function () {
        var _this = this;
        var /** @type {?} */ ret = this.store.get(this.options.meta_key);
        if (ret && ret.v) {
    ...
    function (key, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
        var /** @type {?} */ isPromise = options.mode !== 'none' && this.options.mode === 'promise';
        var /** @type {?} */ value = this.memory.has(key)
            ? this.memory.get(key)
        ...
        return isPromise ? of.of(value.v) : value.v;
    };
    ...
    function (key) {
        if (!this.notifyBuffer.has(key)) {
            var /** @type {?} */ change$ = new BehaviorSubject.BehaviorSubject(this.getNone(key));
...
exports.ɵa = DelonCacheConfig;
exports.ɵb = LocalStorageCacheService;
