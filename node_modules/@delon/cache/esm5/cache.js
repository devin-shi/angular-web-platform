...
var CacheService = /** @class */ (function () {
    ...
    function (key, options) {
        ...
        return isPromise ? of$1(value.v) : value.v;
    };
    ...
    function (key) {
        if (!this.notifyBuffer.has(key)) {
            var /** @type {?} */ change$ = new BehaviorSubject$1(this.getNone(key));
...
export { DC_STORE_STORAGE_TOKEN, CacheService, DelonCacheModule, DelonCacheConfig as ɵa, LocalStorageCacheService as ɵb };
