...
import { ReuseTabMatchMode, ReuseItem, ReuseContextI18n, ReuseContextCloseEvent } from './interface';
export declare class ReuseTabComponent implements OnInit, OnChanges, OnDestroy {
    ...
    constructor(srv: ReuseTabService, cd: ChangeDetectorRef, router: Router, route: ActivatedRoute, el: ElementRef, render: Renderer2, doc: any, i18nSrv: AlainI18NService);
