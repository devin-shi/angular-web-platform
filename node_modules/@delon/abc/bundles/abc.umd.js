...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('@angular/cdk/coercion'), require('@angular/router'), require('ng-zorro-antd'), require('rxjs/operators'), require('@delon/theme'), require('@angular/common/http'), require('file-saver'), require('@delon/util'), require('ngx-countdown'), require('date-fns/format'), require('date-fns/add_seconds'), require('@angular/forms'), require('@delon/acl'), require('rxjs/observable/of'), require('rxjs/observable/combineLatest'), require('rxjs/BehaviorSubject'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('rxjs/Subscription'), require('rxjs/Subject'), require('rxjs/observable/FromEventObservable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/platform-browser', '@angular/cdk/coercion', '@angular/router', 'ng-zorro-antd', 'rxjs/operators', '@delon/theme', '@angular/common/http', 'file-saver', '@delon/util', 'ngx-countdown', 'date-fns/format', 'date-fns/add_seconds', '@angular/forms', '@delon/acl', 'rxjs/observable/of', 'rxjs/observable/combineLatest', 'rxjs/BehaviorSubject', '@angular/cdk/overlay', '@angular/cdk/portal', 'rxjs/Subscription', 'rxjs/Subject', 'rxjs/observable/FromEventObservable'], factory) :
	(factory((global.delon = global.delon || {}, global.delon.abc = {}),global.ng.core,global.ng.common,global.ng.platformBrowser,global.ng.cdk.coercion,global.ng.router,global.ngZorro.antd,global.Rx.Observable.prototype,global.delon.theme,global.ng.common.http,global.saveAs,global.delon.util,global.ngxCountDown,global['date-fns/format/index'],global['date-fns/add_seconds/index'],global.ng.forms,global.delon.acl,global.Rx.Observable,global.Rx.Observable,global.Rx,global.ng.cdk.overlay,global.ng.cdk.portal,global.Rx,global.Rx,global.Rx.Observable));
}(this, (function (exports,core,common,platformBrowser,coercion,router,ngZorroAntd,operators,theme,http,fileSaver,util,ngxCountdown,format,addSeconds,forms,acl,of,combineLatest,BehaviorSubject,overlay,portal,Subscription,Subject,FromEventObservable) { 'use strict';
...
var ErrorCollectComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ErrorCollectComponent.prototype, "freq", {
         ...
         */
        function (value) {
            this._freq = coercion.coerceNumberProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ErrorCollectComponent.prototype, "offsetTop", {
         ...
         */
        function (value) {
            this._offsetTop = coercion.coerceNumberProperty(value);
        },
        enumerable: true,
        configurable: true
    });
...
var AdSidebarNavModule = /** @class */ (function () {
    ...
    AdSidebarNavModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, router.RouterModule, ngZorroAntd.NgZorroAntdModule],
...
var ZORROMODULES = [ngZorroAntd.NgZorroAntdModule];
var AdAvatarListModule = /** @class */ (function () {
    ...
    AdAvatarListModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule].concat(ZORROMODULES),
...
var ZORROMODULES$1 = [ngZorroAntd.NgZorroAntdModule];
...
var ZORROMODULES$2 = [ngZorroAntd.NgZorroAntdModule];
var AdExceptionModule = /** @class */ (function () {
    ...
    AdExceptionModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, router.RouterModule].concat(ZORROMODULES$2),
...
var ZORROMODULES$3 = [ngZorroAntd.NgZorroAntdModule];
...
var PageHeaderComponent = /** @class */ (function () {
    ...
    PageHeaderComponent.propDecorators = {
        ...
        "home_link": [{ type: core.Input },],
        "home_i18n": [{ type: core.Input },],
...
var ZORROMODULES$4 = [ngZorroAntd.NgZorroAntdModule];
var AdPageHeaderModule = /** @class */ (function () {
    ...
    AdPageHeaderModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, router.RouterModule, util.DelonUtilModule].concat(ZORROMODULES$4),
...
var SimpleTableExport = /** @class */ (function () {
    ...
    function (item, col) {
        ...
        if (col.format) {
            ...
            var /** @type {?} */ val = util.deepGet(item, /** @type {?} */ (col.index), '');
...
var SimpleTableComponent = /** @class */ (function () {
    ...
    Object.defineProperty(SimpleTableComponent.prototype, "showPagination", {
         ...
         */
        function (value) {
            this._showPagination = coercion.coerceBooleanProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(SimpleTableComponent.prototype, "loadingDelay", {
         ...
         */
        function (value) {
            this._loadingDelay = coercion.coerceNumberProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(SimpleTableComponent.prototype, "showTotal", {
        ...
        function (value) {
            ...
            else if (coercion.coerceBooleanProperty(value)) {
    ...
    Object.defineProperty(SimpleTableComponent.prototype, "multiSort", {
         ...
         */
        function (value) {
            this._multiSort = coercion.coerceBooleanProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    function (url) {
        ...
        return this.http
            ...
            // list
            var /** @type {?} */ ret = util.deepGet(res, /** @type {?} */ (_this.resReName.list), []);
            if (ret == null || !Array.isArray(ret))
                return [];
            // total
            var /** @type {?} */ retTotal = _this.resReName.total &&
                util.deepGet(res, /** @type {?} */ (_this.resReName.total), null);
    ...
    function (item, col) {
        ...
        var /** @type {?} */ value = util.deepGet(item, /** @type {?} */ (col.index), col.default);
    ...
    function (urlOrData) {
        return urlOrData || Array.isArray(this.data)
            ? of.of((/** @type {?} */ (urlOrData)) || (/** @type {?} */ (this.data)))
            : (/** @type {?} */ (this.data));
    };
    /**
     * @return {?}
    ...
    function () {
        ...
        var /** @type {?} */ idx = 0;
        var /** @type {?} */ newColumns = [];
        var /** @type {?} */ copyColumens = util.deepCopy(this.columns);
    ...
    SimpleTableComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    providers: [SimpleTableExport, theme.CNCurrencyPipe, theme.DatePipe, theme.YNPipe, common.DecimalPipe],
                    preserveWhitespaces: false,
                },] },
    ];
    /** @nocollapse */
    ...
    SimpleTableComponent.propDecorators = {
        ...
        "expand": [{ type: core.ContentChild, args: ['expand',] },],
...
var ZORROMODULES$5 = [ngZorroAntd.NgZorroAntdModule];
var AdSimpleTableModule = /** @class */ (function () {
    ...
    AdSimpleTableModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    imports: [common.CommonModule, forms.FormsModule, util.DelonUtilModule].concat(ZORROMODULES$5),
...
var ReuseTabService = /** @class */ (function () {
    ...
    Object.defineProperty(ReuseTabService.prototype, "title", {
         ...
         */
        function (value) {
            var /** @type {?} */ curUrl = this.getUrl(this.injector.get(router.ActivatedRoute).snapshot);
...
var ReuseTabContextService = /** @class */ (function () {
    ...
    function (context) {
        ...
        var /** @type {?} */ comp = this.ref.attach(new portal.ComponentPortal(ReuseTabContextMenuComponent));
        var /** @type {?} */ instance = comp.instance;
        instance.i18n = this.i18n;
        instance.item = __assign({}, item);
        instance.event = event;
        var /** @type {?} */ sub$ = new Subscription.Subscription();
...
var ReuseTabComponent = /** @class */ (function () {
    ...
    function ReuseTabComponent(srv, cd, router$$1, route, el, render, doc, i18nSrv) {
         ...
         */
        this.close = new core.EventEmitter();
        var /** @type {?} */ route$ = this.router.events.pipe(operators.filter(function (evt) { return evt instanceof router.NavigationEnd; }));
        this.sub$ = /** @type {?} */ (combineLatest.combineLatest(this.srv.change, route$).subscribe(function (_a) {
            var res = _a[0];
    ...
    Object.defineProperty(ReuseTabComponent.prototype, "debug", {
         ...
         */
        function (value) {
            this._debug = coercion.coerceBooleanProperty(value);
        },
        enumerable: true,
        configurable: true
    });
...
var ReuseTabContextDirective = /** @class */ (function () {
    ...
    ReuseTabContextDirective.propDecorators = {
        "item": [{ type: core.Input, args: ['context-menu',] },],
...
var AdReuseTabModule = /** @class */ (function () {
    ...
    AdReuseTabModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, router.RouterModule, ngZorroAntd.NgZorroAntdModule, overlay.OverlayModule],
...
var FullContentComponent = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        this.scroll$ = /** @type {?} */ (FromEventObservable.FromEventObservable.create(window, 'resize')
...
var LodopService = /** @class */ (function () {
    function LodopService(defCog, scriptSrv) {
        ...
        this.pending = false;
        this._lodop = null;
        this._init = new Subject.Subject();
        this._events = new Subject.Subject();
        this.printBuffer = [];
        this.cog = defCog;
    }
    ...
    Object.defineProperty(LodopService.prototype, "lodop", {
        ...
        function () {
            if (this._lodop)
                return of.of(/** @type {?} */ ({ ok: true, lodop: this._lodop }));
            if (this.pending)
...
var G2ChartComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (this.resizeTime <= 200)
            this.resizeTime = 200;
        this.resize$ = /** @type {?} */ (FromEventObservable.FromEventObservable.create(window, 'resize')
...
exports.ɵa = DelonABCRootModule;
exports.ɵp = AvatarListItemComponent;
exports.ɵo = AvatarListComponent;
exports.ɵn = AdAvatarListModule;
exports.ɵdd = G2BarComponent;
exports.ɵdc = AdG2BarModule;
exports.ɵdf = G2CardComponent;
exports.ɵde = AdG2CardModule;
exports.ɵdh = G2ChartComponent;
exports.ɵdg = AdG2ChartModule;
exports.ɵdj = G2GaugeComponent;
exports.ɵdi = AdG2GaugeModule;
exports.ɵdl = G2MiniAreaComponent;
exports.ɵdk = AdG2MiniAreaModule;
exports.ɵdn = G2MiniBarComponent;
exports.ɵdm = AdG2MiniBarModule;
exports.ɵdp = G2ProgressComponent;
exports.ɵdo = AdG2MiniProgressModule;
exports.ɵdr = G2PieComponent;
exports.ɵdq = AdG2PieModule;
exports.ɵdt = G2RadarComponent;
exports.ɵds = AdG2RadarModule;
exports.ɵdv = G2TagCloudComponent;
exports.ɵdu = AdG2TagCloudModule;
exports.ɵdx = G2TimelineComponent;
exports.ɵdw = AdG2TimelineModule;
exports.ɵdz = G2WaterWaveComponent;
exports.ɵdy = AdG2WaterWaveModule;
exports.ɵbr = CountDownComponent;
exports.ɵbq = AdCountDownModule;
exports.ɵs = DescListItemComponent;
exports.ɵr = DescListComponent;
exports.ɵt = AdDescListConfig;
exports.ɵq = AdDescListModule;
exports.ɵj = DownFileDirective;
exports.ɵi = AdDownFileModule;
exports.ɵv = EllipsisComponent;
exports.ɵu = AdEllipsisModule;
exports.ɵc = ErrorCollectComponent;
exports.ɵd = AdErrorCollectConfig;
exports.ɵb = AdErrorCollectModule;
exports.ɵz = ExceptionComponent;
exports.ɵy = AdExceptionModule;
exports.ɵf = FooterToolbarComponent;
exports.ɵe = AdFooterToolbarModule;
exports.ɵck = FullContentToggleDirective;
exports.ɵci = FullContentComponent;
exports.ɵch = AdFullContentModule;
exports.ɵcj = FullContentService;
exports.ɵx = GlobalFooterComponent;
exports.ɵw = AdGlobalFooterModule;
exports.ɵm = AdImageConfig;
exports.ɵl = ImageDirective;
exports.ɵk = AdImageModule;
exports.ɵcv = AdLodopConfig;
exports.ɵct = AdLodopModule;
exports.ɵcu = LodopService;
exports.ɵbc = NoticeIconTabComponent;
exports.ɵbb = NoticeIconComponent;
exports.ɵba = AdNoticeIconModule;
exports.ɵbe = NumberInfoComponent;
exports.ɵbd = AdNumberInfoModule;
exports.ɵcr = AdNumberToChineseModule;
exports.ɵcs = NumberToChinesePipe;
exports.ɵbg = PageHeaderComponent;
exports.ɵbh = AdPageHeaderConfig;
exports.ɵbf = AdPageHeaderModule;
exports.ɵcz = QRComponent;
exports.ɵda = AdQRConfig;
exports.ɵcy = AdQRModule;
exports.ɵdb = QRService;
exports.ɵcx = QuickMenuComponent;
exports.ɵcw = AdQuickMenuModule;
exports.ɵbj = ResultComponent;
exports.ɵbi = AdResultModule;
exports.ɵce = ReuseTabContextMenuComponent;
exports.ɵcf = ReuseTabContextComponent;
exports.ɵcg = ReuseTabContextDirective;
exports.ɵcc = ReuseTabContextService;
exports.ɵcb = ReuseTabComponent;
exports.ɵca = AdReuseTabModule;
exports.ɵcd = ReuseTabService;
exports.ɵh = SidebarNavComponent;
exports.ɵg = AdSidebarNavModule;
exports.ɵbu = SimpleTableExport;
exports.ɵbz = SimpleTableRowDirective;
exports.ɵbt = SimpleTableComponent;
exports.ɵby = AdSimpleTableConfig;
exports.ɵbs = AdSimpleTableModule;
exports.ɵbl = StandardFormRowComponent;
exports.ɵbk = AdStandardFormRowModule;
exports.ɵbn = TagSelectComponent;
exports.ɵbm = AdTagSelectModule;
exports.ɵbp = TrendComponent;
exports.ɵbo = AdTrendModule;
exports.ɵbw = DA_XLSX_CONFIG;
exports.ɵcm = XlsxDirective;
exports.ɵcl = AdXlsxModule;
exports.ɵbv = XlsxService;
exports.ɵcp = DA_ZIP_CONFIG;
exports.ɵcn = AdZipModule;
exports.ɵco = ZipService;
