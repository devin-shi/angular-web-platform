...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/coercion'), require('@delon/util'), require('rxjs/operators'), require('rxjs/observable/of'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('rxjs/observable/combineLatest'), require('rxjs/Observable'), require('@angular/common'), require('@angular/forms'), require('ng-zorro-antd'), require('date-fns/format')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/cdk/coercion', '@delon/util', 'rxjs/operators', 'rxjs/observable/of', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'rxjs/observable/combineLatest', 'rxjs/Observable', '@angular/common', '@angular/forms', 'ng-zorro-antd', 'date-fns/format'], factory) :
	(factory((global.delon = global.delon || {}, global.delon.form = {}),global.ng.core,global.ng.cdk.coercion,global.delon.util,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx,global.Rx,global.Rx.Observable,global.Rx,global.ng.common,global.ng.forms,global.ngZorro.antd,global['date-fns/format/index']));
}(this, (function (exports,core,coercion,util,operators,of,Subject,BehaviorSubject,combineLatest,Observable,common,forms,ngZorroAntd,format) { 'use strict';
...
function getCopyEnum(list, formData) {
    return getEnum(util.deepCopy(list || []), formData);
}
/**
 * @param {?} schema
 * @param {?} ui
...
function getData(schema, ui, formData, asyncArgs) {
    if (typeof ui.asyncData === 'function') {
        return ui
            .asyncData(asyncArgs)
            .pipe(operators.takeWhile(function () { return ui["__destroy"] !== true; }), operators.map(function (list) { return getEnum(list, formData); }));
    }
    return of.of(getCopyEnum(schema.enum, formData));
}
...
var FormProperty = /** @class */ (function () {
    function FormProperty(schemaValidatorFactory, schema, ui, formData, parent, path, options) {
        ...
        this._errors = null;
        this._objErrors = {};
        this._valueChanges = new BehaviorSubject.BehaviorSubject(null);
        this._errorsChanges = new BehaviorSubject.BehaviorSubject(null);
        this._visible = true;
        this._visibilityChanges = new BehaviorSubject.BehaviorSubject(true);
        this.schema = schema;
        this.ui = ui;
    ...
    function () {
        ...
        if (typeof customValidator === 'function') {
            ...
            if (customErrors instanceof Observable.Observable) {
    ...
    function () {
        ...
        if (typeof visibleIf === 'object' && Object.keys(visibleIf).length === 0) {
            ...
            var _loop_1 = function (dependencyPath) {
                if (visibleIf.hasOwnProperty(dependencyPath)) {
                    ...
                    if (property) {
                        ...
                        var /** @type {?} */ and = combineLatest.combineLatest([valueCheck, visibilityCheck], function (v1, v2) { return v1 && v2; });
            ...
            combineLatest.combineLatest(propertiesBinding, function () {
                var values = [];
                for (var _i = 0; _i < arguments.length; _i++) {
...
var SFComponent = /** @class */ (function () {
    ...
    Object.defineProperty(SFComponent.prototype, "liveValidate", {
         ...
         */
        function (value) {
            this._liveValidate = coercion.coerceBooleanProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SFComponent.prototype, "firstVisual", {
         ...
         */
        function (value) {
            this._firstVisual = coercion.coerceBooleanProperty(value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    function () {
        ...
        var /** @type {?} */ _schema = util.deepCopy(this.schema);
...
var TransferWidget = /** @class */ (function (_super) {
    ...
    function TransferWidget() {
        ...
        _this._canMove = function (arg) {
            return _this.ui["canMove"] ? _this.ui["canMove"](arg) : of.of(arg.list);
        };
        return _this;
    }
    /**
...
var AutoCompleteWidget = /** @class */ (function (_super) {
    ...
    function () {
        ...
        }), operators.map(function (res) { return getEnum(res, null); }));
    };
    /**
     * @param {?} value
     * @return {?}
    ...
    function (input) {
        ...
        switch (this.ui.type) {
            ...
            default:
                return of.of(this.fixData.filter(function (option) { return _this.filterOption(input, option); }));
        }
    };
    /**
     * @param {?} value
     ...
     */
    function (value) {
        return of.of(!value || ~value.indexOf('@')
            ? []
...
var MentionWidget = /** @class */ (function (_super) {
    ...
    function (option) {
        ...
        (/** @type {?} */ (this.ui["loadData"](option)))
            .pipe(operators.tap(function () { return (_this.loading = false); }), operators.map(function (res) { return getEnum(res, null); }))
...
var DelonFormModule = /** @class */ (function () {
    ...
    DelonFormModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, forms.FormsModule, util.DelonUtilModule, ngZorroAntd.NgZorroAntdModule],
