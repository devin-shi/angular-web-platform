import { OnInit, OnChanges, OnDestroy, SimpleChanges, SimpleChange, EventEmitter, ChangeDetectorRef } from '@angular/core';
...
export declare class SFComponent implements OnInit, OnChanges, OnDestroy {
     ...
     */
    liveValidate: any;
    private _liveValidate;
    /** 指定表单 `autocomplete` 值 */
    autocomplete: 'on' | 'off';
    /** 立即显示错误视觉 */
    firstVisual: any;
    private _firstVisual;
    /** 表单模式 */
    ...
    constructor(formPropertyFactory: FormPropertyFactory, terminator: TerminatorService, options: DelonFormConfig, cd: ChangeDetectorRef);
