...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/BehaviorSubject'), require('@angular/router'), require('rxjs/Observable'), require('rxjs/observable/of'), require('rxjs/operators'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/BehaviorSubject', '@angular/router', 'rxjs/Observable', 'rxjs/observable/of', 'rxjs/operators', '@angular/common'], factory) :
	(factory((global.delon = global.delon || {}, global.delon.acl = {}),global.ng.core,global.Rx,global.ng.router,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.ng.common));
}(this, (function (exports,core,BehaviorSubject,router,Observable,of,operators,common) { 'use strict';
...
var ACLService = /** @class */ (function () {
    function ACLService() {
        ...
        this.abilities = [];
        this.full = false;
        this.aclChange = new BehaviorSubject.BehaviorSubject(null);
    }
...
var ACLGuard = /** @class */ (function () {
    ...
    function (guard) {
        var _this = this;
        return (guard && guard instanceof Observable.Observable
            ? guard
            : of.of(typeof guard !== 'undefined' && guard !== null
                ? (/** @type {?} */ (guard))
