...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('deep-extend'), require('date-fns/parse'), require('date-fns/start_of_week'), require('date-fns/end_of_week'), require('date-fns/sub_weeks'), require('date-fns/start_of_month'), require('date-fns/end_of_month'), require('date-fns/sub_months'), require('date-fns/start_of_year'), require('date-fns/end_of_year'), require('date-fns/sub_years'), require('date-fns/add_days'), require('@angular/core'), require('@angular/platform-browser'), require('rxjs/BehaviorSubject'), require('rxjs/operators'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', 'deep-extend', 'date-fns/parse', 'date-fns/start_of_week', 'date-fns/end_of_week', 'date-fns/sub_weeks', 'date-fns/start_of_month', 'date-fns/end_of_month', 'date-fns/sub_months', 'date-fns/start_of_year', 'date-fns/end_of_year', 'date-fns/sub_years', 'date-fns/add_days', '@angular/core', '@angular/platform-browser', 'rxjs/BehaviorSubject', 'rxjs/operators', '@angular/common'], factory) :
	(factory((global.delon = global.delon || {}, global.delon.util = {}),global['deep-extend'],global['date-fns/parse/index'],global['date-fns/start_of_week/index'],global['date-fns/end_of_week/index'],global['date-fns/sub_weeks/index'],global['date-fns/start_of_month/index'],global['date-fns/end_of_month/index'],global['date-fns/sub_months/index'],global['date-fns/start_of_year/index'],global['date-fns/end_of_year/index'],global['date-fns/sub_years/index'],global['date-fns/add_days/index'],global.ng.core,global.ng.platformBrowser,global.Rx,global.Rx.Observable.prototype,global.ng.common));
}(this, (function (exports,deepExtend,parse,startOfWeek,endOfWeek,subWeeks,startOfMonth,endOfMonth,subMonths,startOfYear,endOfYear,subYears,addDays,core,platformBrowser,BehaviorSubject,operators,common) { 'use strict';

deepExtend = deepExtend && deepExtend.hasOwnProperty('default') ? deepExtend['default'] : deepExtend;
...
var LazyService = /** @class */ (function () {
    function LazyService(doc) {
        ...
        this.list = {};
        this.cached = {};
        this._notify = new BehaviorSubject.BehaviorSubject([]);
    }
