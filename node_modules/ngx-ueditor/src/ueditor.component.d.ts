import { ElementRef, OnDestroy, EventEmitter, OnInit, ChangeDetectorRef, AfterViewInit, OnChanges, SimpleChanges } from '@angular/core';
...
export declare class UEditorComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy, ControlValueAccessor {
    ...
    constructor(el: ElementRef, ss: ScriptService, router: Router, defConfig: UEditorConfig, cd: ChangeDetectorRef);
    ngOnInit(): void;
