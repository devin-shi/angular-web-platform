import { ApplicationRef, ChangeDetectionStrategy, ChangeDetectorRef, Component, ComponentFactoryResolver, ContentChild, ContentChildren, Directive, ElementRef, EventEmitter, Host, HostBinding, HostListener, Inject, Injectable, InjectionToken, Injector, Input, IterableDiffers, NgModule, NgZone, Optional, Output, Pipe, Renderer2, Self, SimpleChange, SkipSelf, TemplateRef, Type, ViewChild, ViewChildren, ViewContainerRef, forwardRef } from '@angular/core';
...
import { distinct as distinct$1 } from 'rxjs/operators/distinct';
...
class NzAutocompleteOptionComponent {
     ...
     * @return {?}
     */
    get nzDisabled() { return this.disabled; }
    /**
     * @param {?} value
     * @return {?}
     */
    set nzDisabled(value) { this.disabled = toBoolean(value); }
    /**
     * 选择
     * @return {?}
     */
...
class NzAutocompleteComponent {
    ...
    constructor(changeDetectorRef, _ngZone) {
         ...
         */
        this.optionSelectionChanges = defer$1(() => {
            if (this.options) {
                return merge$1(...this.options.map(option => option.selectionChange));
            }
            return this._ngZone.onStable
                .asObservable()
                .pipe(take$1(1), switchMap$1(() => this.optionSelectionChanges));
        });
    }
    /**
    ...
    subscribeOptionChanges() {
        this.selectionChangeSubscription = this.optionSelectionChanges
            .pipe(filter$1((event) => event.isUserInput))
            .subscribe((event) => {
            event.source.select();
...
class NzAutocompleteTriggerDirective {
    ...
    subscribeOptionsChange() {
        return this.nzAutocomplete.options.changes.pipe(delay$1(0)).subscribe(() => {
    ...
    subscribeOverlayPositionChange() {
        return this.positionStrategy.onPositionChange
            .pipe(map$1((position) => position.connectionPair.originY), distinct$1())
            .subscribe((position) => {
     ...
     */
    getOverlayPosition() {
        this.positionStrategy = this._overlay.position().connectedTo(this.getConnectedElement(), { originX: 'start', originY: 'bottom' }, { overlayX: 'start', overlayY: 'top' })
    ...
    setValueAndClose(option) {
        const /** @type {?} */ value = option.getLabel();
...
/** @nocollapse */
NzAutocompleteModule.ctorParameters = () => [];
...
/** @nocollapse */
NzSubOptionPipe.ctorParameters = () => [];
/**
 * @param {?} input
 * @param {?} option
 * @return {?}
...
class NzOptionContainerComponent {
    ...
    watchSubOptionChanges() {
        ...
        let /** @type {?} */ optionChanges$ = new Subject$1().asObservable().pipe(merge$3(this.listOfNzOptionGroupComponent.changes)).pipe(merge$3(this.listOfNzOptionComponent.changes));
        if (this.listOfNzOptionGroupComponent.length) {
            this.listOfNzOptionGroupComponent.forEach(group => optionChanges$ = group.listOfNzOptionComponent ? optionChanges$.pipe(merge$3(group.listOfNzOptionComponent.changes)) : optionChanges$);
        }
...
/** @nocollapse */
NzOptionGroupComponent.ctorParameters = () => [];
...
/** @nocollapse */
NzSelectUnselectableDirective.ctorParameters = () => [];
...
/** @nocollapse */
NzDateCellDirective.ctorParameters = () => [];
...
/** @nocollapse */
NzMonthCellDirective.ctorParameters = () => [];
...
/** @nocollapse */
NzDateFullCellDirective.ctorParameters = () => [];
...
/** @nocollapse */
NzMonthFullCellDirective.ctorParameters = () => [];
...
/** @nocollapse */
NzCardTabComponent.ctorParameters = () => [];
...
/** @nocollapse */
NzDividerModule.ctorParameters = () => [];
...
class NzDropDownDirective {
    ...
    constructor(elementRef, renderer) {
        this.elementRef = elementRef;
        this.renderer = renderer;
        this.$mouseenter = new Subject$1();
        this.$mouseleave = new Subject$1();
        this.$click = new Subject$1();
    }
    /**
     * @param {?} e
     * @return {?}
...
class NzDropDownComponent {
    ...
    constructor(renderer, changeDetector) {
        ...
        this.$subOpen = new BehaviorSubject$1(false);
        this.$visibleChange = new Subject$1();
    ...
    startSubscribe(observable$) {
        ...
        if (this.nzClickHide) {
            const /** @type {?} */ $menuItemClick = this.nzMenu.nzClick.asObservable().pipe(mapTo$1(false));
            $pre = $pre.pipe(merge$3($menuItemClick));
        }
        const /** @type {?} */ final$ = $pre.pipe(combineLatest$1(this.$subOpen), map$1(value => value[0] || value[1]), debounceTime$1(50), distinctUntilChanged$1());
    ...
    ngAfterViewInit() {
        let /** @type {?} */ mouse$;
        if (this.nzTrigger === 'hover') {
            const /** @type {?} */ mouseEnterOrigin$ = this.nzOrigin.$mouseenter.pipe(mapTo$1(true));
            const /** @type {?} */ mouseLeaveOrigin$ = this.nzOrigin.$mouseleave.pipe(mapTo$1(false));
            mouse$ = mouseEnterOrigin$.pipe(merge$3(mouseLeaveOrigin$));
        }
        if (this.nzTrigger === 'click') {
            mouse$ = this.nzOrigin.$click.pipe(mapTo$1(true));
        }
        const /** @type {?} */ observable$ = mouse$.pipe(merge$3(this.$visibleChange));
...
class NzSubMenuComponent {
    ...
    constructor(nzMenuDirective, cd, nzSubMenuComponent, nzDropDownComponent, nzDropDownButtonComponent) {
        ...
        this._open = false;
        this._disabled = false;
        this.$mouseSubject = new Subject$1();
    ...
    ngOnInit() {
        ...
        const /** @type {?} */ $combineAll = this.$mouseSubject.asObservable().pipe(combineLatest$1(this.$subOpen), map$1(value => value[0] || value[1]), auditTime$1(150));
...
class NzDropdownService {
     ...
     * @param {?} zone
     */
    constructor(overlay$$1, document, zone) {
    ...
    createOverlay($event) {
        ...
        const /** @type {?} */ defaultPosition = this.positions[0];
        const /** @type {?} */ originPoint = { originX: defaultPosition.originX, originY: defaultPosition.originY };
        const /** @type {?} */ overlayPoint = { overlayX: defaultPosition.overlayX, overlayY: defaultPosition.overlayY };
        const /** @type {?} */ fakeElementRef = { nativeElement: this.locatePoint };
...
class NzSpinComponent {
    ...
    constructor(elementRef, renderer, zone) {
        ...
        this._delay = 0;
        this.isNested = false;
        this.baseSpinning$ = new BehaviorSubject$1(true);
        this.resultSpinning$ = this.baseSpinning$.asObservable().pipe(debounceTime$1(this.nzDelay));
        this.nzSize = 'default';
        this.el = this.elementRef.nativeElement;
    }
    /**
...
/** @nocollapse */
NzMentionSuggestionDirective.ctorParameters = () => [];
...
class NzMentionComponent {
     ...
     */
    constructor(document, ngZone, overlay$$1, viewContainerRef) {
        this.document = document;
        this.ngZone = ngZone;
        this.overlay = overlay$$1;
     ...
     * @return {?}
     */
    get nzSuggestions() { return this._suggestions; }
    /**
     * @param {?} value
     * @return {?}
     */
    set nzPlacement(value) { this._placement = value; }
    /**
     * @return {?}
     */
     ...
     * @return {?}
     */
    set suggestionChild(value) { if (value) {
     ...
     */
    subscribeOverlayBackdropClick() {
        return merge$1(fromEvent$1(this.document, 'click'), fromEvent$1(this.document, 'touchend'))
            .subscribe((event) => {
            const /** @type {?} */ clickTarget = /** @type {?} */ (event.target);
     ...
     */
    getOverlayPosition() {
        this.positionStrategy = this.overlay.position().connectedTo(this.trigger.el, { originX: 'start', originY: 'bottom' }, { overlayX: 'start', overlayY: 'top' })
            .withFallbackPosition({ originX: 'start', originY: 'top' }, { overlayX: 'start', overlayY: 'bottom' });
        return this.positionStrategy;
    }
}
...
/** @nocollapse */
NzMentionModule.ctorParameters = () => [];
...
class NzMessageBaseService {
     ...
     * @param {?=} _idPrefix
     */
    constructor(overlay$$1, containerClass, injector, cfr, appRef, _idPrefix = '') {
        this.overlay = overlay$$1;
    ...
    createContainer() {
        ...
        this.overlay.create().overlayElement.appendChild(/** @type {?} */ ((/** @type {?} */ (componentRef.hostView)).rootNodes[0]));
...
class NzMessageService extends NzMessageBaseService {
     ...
     * @param {?} appRef
     */
    constructor(overlay$$1, injector, cfr, appRef) {
        super(overlay$$1, NzMessageContainerComponent, injector, cfr, appRef, 'message-');
    }
    /**
     * @param {?} content
     * @param {?=} options
...
class NzModalControlService {
    ...
    constructor(parentService) {
        ...
        this.rootAfterAllClose = this.parentService ? null : new Subject$1();
...
class NzModalComponent extends NzModalRef {
     ...
     * @param {?} document
     */
    constructor(overlay$$1, locale, renderer, cfr, elementRef, viewContainer, nzMeasureScrollbarService, modalControl, document) {
        // tslint:disable-line:no-any
        super();
        this.overlay = overlay$$1;
        this.locale = locale;
     ...
     */
    onClickMask($event) {
        if (this.nzMask && this.nzMaskClosable && (/** @type {?} */ ($event.target)).classList.contains('ant-modal-wrap')) {
            this.onClickOkCancel('cancel');
        }
    }
    /**
    ...
    onClickOkCancel(type) {
        ...
        if (trigger$$1 instanceof EventEmitter) {
            ...
            const /** @type {?} */ caseClose = (doClose) => (doClose !== false) && this.close(); // Users can return "false" to prevent closing by default
            if (isPromise(result)) {
...
class NzModalService {
     ...
     * @param {?} modalControl
     */
    constructor(overlay$$1, logger, modalControl) {
        this.overlay = overlay$$1;
        this.logger = logger;
        this.modalControl = modalControl;
    }
...
class NzNotificationService extends NzMessageBaseService {
     ...
     */
    constructor(overlay$$1, injector, cfr, appRef) {
        super(overlay$$1, NzNotificationContainerComponent, injector, cfr, appRef, 'notification-');
    }
    /**
     * @param {?} title
     * @param {?} content
...
class NzThComponent {
    ...
    search() {
        if (this.nzFilterMultiple) {
            const /** @type {?} */ filterList = this.multipleFilterList.filter(item => item.checked).map(item => item.value);
            ...
            const /** @type {?} */ filterValue = checkedFilter ? checkedFilter.value : null;
...
class NzTableComponent {
     ...
     * @param {?} nzMeasureScrollbarService
     */
    constructor(elementRef, cdr, overlay$$1, nzMeasureScrollbarService) {
        this.elementRef = elementRef;
        this.cdr = cdr;
        this.overlay = overlay$$1;
        this.nzMeasureScrollbarService = nzMeasureScrollbarService;
    ...
    ngOnInit() {
        ...
        if (this.nzScroll && this.nzScroll.x && this.nzScroll.y) {
             ...
             */
            const /** @type {?} */ overlay$$1 = this.overlay.create();
            overlay$$1.dispose();
        }
    }
    /**
...
class NzTheadComponent {
     ...
     */
    ngAfterContentInit() {
        let /** @type {?} */ sortChange = new Subject$1().asObservable();
        ...
        if (sortChangeArray.length) {
            sortChangeArray.forEach(sort => {
                sortChange = sortChange.pipe(merge$3(sort.asObservable()));
            });
        }
...
class NzTabsNavComponent {
    ...
    ngAfterContentInit() {
        this.realignInkBar = this.ngZone.runOutsideAngular(() => {
            const /** @type {?} */ dirChange = this.dir ? this.dir.change : of$1(null);
            const /** @type {?} */ resize = typeof window !== 'undefined' ?
                fromEvent$1(window, 'resize').pipe(auditTime$1(10)) :
                of$1(null);
            return merge$1(dirChange, resize).pipe(startWith$1(null)).subscribe(() => {
                if (this.nzShowPagination) {
                    this.updatePagination();
                }
                this.alignInkBarToSelectedTab();
...
NzTimePickerPanelComponent.decorators = [
    { type: Component, args: [{
                ...
                template: `<div class="ant-time-picker-panel-inner" [style.width.px]="enabledColumns * 56"> <div class="ant-time-picker-panel-input-wrap"> <input type="text" class="ant-time-picker-panel-input" [placeholder]="nzPlaceHolder" [nzTime]="format" [(ngModel)]="time.value" (blur)="time.changed()"> <a *ngIf="nzAllowEmpty" class="ant-time-picker-panel-clear-btn" [attr.title]="nzClearText" (click)="clear()"> </a> </div> <div class="ant-time-picker-panel-combobox"> <div *ngIf="hourEnabled" #hourListElement class="ant-time-picker-panel-select"> <ul> <ng-container *ngFor="let hour of hourRange"> <li *ngIf="!(nzHideDisabledOptions && hour.disabled)" (click)="selectHour(hour)" [class.ant-time-picker-panel-select-option-selected]="isSelectedHour(hour)" [class.ant-time-picker-panel-select-option-disabled]="hour.disabled"> {{ hour.index | number:'2.0-0' }} </li> </ng-container> </ul> </div> <div *ngIf="minuteEnabled" #minuteListElement class="ant-time-picker-panel-select"> <ul> <ng-container *ngFor="let minute of minuteRange"> <li *ngIf="!(nzHideDisabledOptions && minute.disabled)" (click)="selectMinute(minute)" [class.ant-time-picker-panel-select-option-selected]="isSelectedMinute(minute)" [class.ant-time-picker-panel-select-option-disabled]="minute.disabled"> {{ minute.index | number:'2.0-0' }} </li> </ng-container> </ul> </div> <div *ngIf="secondEnabled" #secondListElement class="ant-time-picker-panel-select"> <ul> <ng-container *ngFor="let second of secondRange"> <li *ngIf="!(nzHideDisabledOptions && second.disabled)" (click)="selectSecond(second)" [class.ant-time-picker-panel-select-option-selected]="isSelectedSecond(second)" [class.ant-time-picker-panel-select-option-disabled]="second.disabled"> {{ second.index | number:'2.0-0' }} </li> </ng-container> </ul> </div> </div> <div class="ant-time-picker-panel-addon" *ngIf="nzAddOn"> <ng-template [ngTemplateOutlet]="nzAddOn"></ng-template> </div> </div> `,
                providers: [
                    NzUpdateHostClassService,
...
class NzTimePickerComponent {
     ...
     * @param {?} updateCls
     */
    constructor(element, renderer, overlay$$1, positionBuilder, i18n, updateCls) {
        this.element = element;
        this.renderer = renderer;
        this.overlay = overlay$$1;
...
class NzTransferComponent {
    ...
    constructor(i18n, el) {
        ...
        this.nzTitles = ['', ''];
        this.nzOperations = [];
        this.nzItemUnit = this.i18n.translate('Transfer.itemUnit');
        this.nzItemsUnit = this.i18n.translate('Transfer.itemsUnit');
        this.nzCanMove = (arg) => of$1(arg.list);
        this.nzSearchPlaceholder = this.i18n.translate('Transfer.searchPlaceholder');
        this.nzNotFoundContent = this.i18n.translate('Transfer.notFoundContent');
        // events
        this.nzChange = new EventEmitter();
...
class NzTreeNodeComponent {
    ...
    ngAfterViewInit() {
        if (this.nzDraggable) {
            this.ngZone.runOutsideAngular(() => {
                fromEvent$1(this.dragElement.nativeElement, 'dragstart').subscribe((e) => this.handleDragStart(e));
                fromEvent$1(this.dragElement.nativeElement, 'dragenter').subscribe((e) => this.handleDragEnter(e));
                fromEvent$1(this.dragElement.nativeElement, 'dragover').subscribe((e) => this.handleDragOver(e));
                fromEvent$1(this.dragElement.nativeElement, 'dragleave').subscribe((e) => this.handleDragLeave(e));
                fromEvent$1(this.dragElement.nativeElement, 'drop').subscribe((e) => this.handleDragDrop(e));
                fromEvent$1(this.dragElement.nativeElement, 'dragend').subscribe((e) => this.handleDragEnd(e));
            });
        }
    }
    /**
...
class NzUploadListComponent {
     ...
     * @param {?} i18n
     */
    constructor(el, updateHostClassService, i18n) {
        this.el = el;
        this.updateHostClassService = updateHostClassService;
        this.i18n = i18n;
...
class NzUploadComponent {
    ...
    constructor(cd, i18n) {
        ...
        this.nzChange = new EventEmitter();
        this.uploadErrorText = this.i18n.translate('Upload.uploadError');
        this.onStart = (file) => {
            if (!this.nzFileList) {
                this.nzFileList = [];
            }
        ...
        this.onRemove = (file) => {
            ...
            file.status = 'removed';
            (/** @type {?} */ ((this.nzRemove ? this.nzRemove instanceof Observable$1 ? this.nzRemove : of$1(this.nzRemove(file)) : of$1(true))))
